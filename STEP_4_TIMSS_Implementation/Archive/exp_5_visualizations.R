...
if (!exists("all_results")) {
  load("STEP_3_Application_Implementation/results/exp5_transformation_validation_full.RData")
}
...
dir.create("STEP_3_Application_Implementation/results/figures/exp5_transformation_validation", 
...
create_method_dashboard <- function(method_name, results, empirical_U, empirical_V) {
  ...
  pdf(paste0("STEP_3_Application_Implementation/results/figures/exp5_transformation_validation/", method_name, "_dashboard.pdf"),
      width = 10, height = 10)
...
pdf("STEP_3_Application_Implementation/results/figures/exp5_transformation_validation/uniformity_forest_plot.pdf",
    width = 10, height = 8)
...
pdf("STEP_3_Application_Implementation/results/figures/exp5_transformation_validation/tail_concentration_comparison.pdf",
    width = 12, height = 6)
...
pdf("STEP_3_Application_Implementation/results/figures/exp5_transformation_validation/copula_selection_results.pdf",
    width = 10, height = 8)
...
pdf("STEP_3_Application_Implementation/results/figures/exp5_transformation_validation/tradeoff_space.pdf",
    width = 10, height = 8)
...
pdf("STEP_3_Application_Implementation/results/figures/exp5_transformation_validation/key_methods_comparison.pdf",
    width = 14, height = 10)
