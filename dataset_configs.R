...
DATASETS <- list(
  ...
  dataset_1 = list(
    ...
    ec2_path = "/home/ec2-user/SGP/Dropbox/TEMP/Copula_Sensitivity_Data_Set_1.Rdata",
  ...
  dataset_2 = list(
    ...
    ec2_path = "/home/ec2-user/SGP/Dropbox/TEMP/Copula_Sensitivity_Data_Set_2.Rdata",
  ...
  dataset_3 = list(
    ...
    ec2_path = "/home/ec2-user/SGP/Dropbox/TEMP/Copula_Sensitivity_Data_Set_3.Rdata",
