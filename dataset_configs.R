...
DATASETS <- list(
  ...
  dataset_1 = list(
    ...
    ec2_path = "/data/Dropbox/Damian Betebenner/TEMP/Data/Copula_Sensitivity_Data_Set_1.Rdata",
  ...
  dataset_2 = list(
    ...
    ec2_path = "/data/Dropbox/Damian Betebenner/TEMP/Data/Copula_Sensitivity_Data_Set_2.Rdata",
  ...
  dataset_3 = list(
    ...
    ec2_path = "/data/Dropbox/Damian Betebenner/TEMP/Data/Copula_Sensitivity_Data_Set_3.Rdata",
