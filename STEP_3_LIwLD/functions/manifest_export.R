...
export_phase_a_manifest <- function(phase_a_results,
  ...
  manifest <- list(
    ...
    output_files = list(
      ...
      panel_b_regime = file.path(output_dir, "visualizations", "phase_a", "panel_b_regime_comparison.pdf"),
      panel_c_residual = file.path(output_dir, "visualizations", "phase_a", "panel_c_residual_curve.pdf"),
