...
MATHEMATICS_2008.config <- list(
  MATHEMATICS_2008 = list(
...
MATHEMATICS_2008_g10.config <- list(
  MATHEMATICS_2008 = list(
    sgp.content.areas = rep("MATHEMATICS", 2),
    sgp.panel.years = c("2006", "2008"),
    sgp.grade.sequences = list(
      c("8", "10")
    )
  )
...
MATHEMATICS_2009.config <- list(
  MATHEMATICS_2009 = list(
    sgp.content.areas = rep("MATHEMATICS", 3),
...
MATHEMATICS_2009_g10.config <- list(
  MATHEMATICS_2009 = list(
    sgp.content.areas = rep("MATHEMATICS", 2),
    sgp.panel.years = c("2007", "2009"),
    sgp.grade.sequences = list(
      c("8", "10")
    )
  )
...
MATHEMATICS_2010_g10.config <- list(
  MATHEMATICS_2010 = list(
    sgp.content.areas = rep("MATHEMATICS", 2),
...
MATHEMATICS_2011_g10.config <- list(
  MATHEMATICS_2011 = list(
    sgp.content.areas = rep("MATHEMATICS", 2),
...
MATHEMATICS_2012_g10.config <- list(
...
MATHEMATICS_2013_g10.config <- list(
  MATHEMATICS_2013 = list(
    sgp.content.areas = rep("MATHEMATICS", 2),
...
MATHEMATICS_2014_g10.config <- list(
  MATHEMATICS_2014 = list(
    sgp.content.areas = rep("MATHEMATICS", 2),
