...
source("SGP_CONFIG/WRITING_config.R")
dataset_1_sgp_config <- c(
...
dataset_1_SGP_Object <- abcSGP(
                ...
                state = "DATASET_1",
                sgp.config = dataset_1_sgp_config,
...
# Save SGP results
variables.to.save <- setdiff(names(dataset_1_SGP_Object@Data), c("SCALE_SCORE_PRIOR_STANDARDIZED", "SGP_NORM_GROUP"))
Copula_Sensitivity_Data_Set_1_SGP <- dataset_1_SGP_Object@Data[, variables.to.save, with = FALSE]
