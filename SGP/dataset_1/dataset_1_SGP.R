...
dataset_1_knots_boundaries <- SGP::createKnotsBoundaries(
  Copula_Sensitivity_Data_Set_1
)

# Embed knots and boundaries into SGPstateData
SGPstateData[["DATASET_1"]][["Achievement"]][[
  "Knots_Boundaries"
]] <- dataset_1_knots_boundaries
...
dataset_1_span_1_year_sgp_config <- c(
  MATHEMATICS_2006.config,
  READING_2006.config,
  WRITING_2006.config,
  MATHEMATICS_2007.config,
  READING_2007.config,
  WRITING_2007.config,
  MATHEMATICS_2008.config,
  READING_2008.config,
  WRITING_2008.config,
  MATHEMATICS_2009.config,
  READING_2009.config,
  WRITING_2009.config,
  MATHEMATICS_2010.config,
  READING_2010.config,
  WRITING_2010.config,
  MATHEMATICS_2011.config,
  READING_2011.config,
  WRITING_2011.config,
  MATHEMATICS_2012.config,
  READING_2012.config,
  WRITING_2012.config,
  MATHEMATICS_2013.config,
  READING_2013.config,
  WRITING_2013.config,
...
for (span_config in seq_along(dataset_1_config)) {
  ...
  variables.to.save <- intersect(
    names(dataset_1_SGP_Object@Data),
    c("SGP", "SGP_ORDER_1", "SGP_ORDER_2", "SGP_ORDER", "SCALE_SCORE_PRIOR")
  )
  Copula_Sensitivity_Data_Set_1_SGP[,
    (variables.to.save) := dataset_1_SGP_Object@Data[,
      (variables.to.save),
      with = FALSE
    ]
  ]
...
save(
  Copula_Sensitivity_Data_Set_1_SGP,
  file = "../../Data/Copula_Sensitivity_Data_Set_1_SGP.Rdata"
)
