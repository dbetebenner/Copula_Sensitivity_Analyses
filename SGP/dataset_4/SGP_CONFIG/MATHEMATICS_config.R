...
MATHEMATICS_2019.g11.config <- list(
  MATHEMATICS_2019_g11 = list(
    sgp.content.areas = rep("MATHEMATICS", 2),
...
MATHEMATICS_2021.g11.config <- list(
  MATHEMATICS_2021_g11 = list(
    sgp.content.areas = rep("MATHEMATICS", 3),
...
MATHEMATICS_2022.g11.config <- list(
  MATHEMATICS_2022_g11 = list(
    sgp.content.areas = rep("MATHEMATICS", 3),
...
MATHEMATICS_2024.g11.config <- list(
  MATHEMATICS_2024_g11 = list(
    sgp.content.areas = rep("MATHEMATICS", 2),
...
MATHEMATICS_2025.g11.config <- list(
  MATHEMATICS_2025_g11 = list(
    sgp.content.areas = rep("MATHEMATICS", 3),
