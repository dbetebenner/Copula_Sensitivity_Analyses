...
if (length(unique(pvalues)) == 1) {
  ...
  print(pvalues_n100)
  cat(
    "\nAre all p-values identical with N=100?:",
    length(unique(pvalues_n100)) == 1,
    "\n"
  )
}
...
cat(
  "\nAre all p-values identical without seed?:",
  length(unique(pvalues_noseed)) == 1,
  "\n"
)
